...
<div class="container-fluid py-4">
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-xl-3 col-md-6">
            ...
            <a href="{{ route('author.manuscripts.drafts') }}"
               class="text-decoration-none">
        ...
        <div class="col-xl-3 col-md-6">
            ...
            <a href="{{ route('author.manuscripts.submitted') }}"
               class="text-decoration-none">
        ...
        <div class="col-xl-3 col-md-6">
            ...
            <a href="{{ route('author.manuscripts.review') }}"
               class="text-decoration-none">
        ...
        <div class="col-xl-3 col-md-6">
            ...
            <a href="{{ route('author.manuscripts.revisions') }}"
               class="text-decoration-none">
        ...
        <div class="col-xl-3 col-md-6">
            ...
            <a href="{{ route('author.manuscripts.accepted') }}"
               class="text-decoration-none">
        ...
        <div class="col-xl-3 col-md-6">
            ...
            <a href="{{ route('author.manuscripts.published') }}"
               class="text-decoration-none">
        ...
        <div class="card-body">
            ...
            <div class="row g-3">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <a href="{{ route('author.notifications.index') }}"
        ...
        <div class="col-lg-6">
            ...
            <div class="card border-0 shadow-sm h-100">
                ...
                <div class="card-header bg-white
                    ...
                    <a href="{{ route('author.activity.index') }}"
                       class="small">
