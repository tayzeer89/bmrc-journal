...
@section('title', 'Reviewer Login | BMRC Journal')
    ...
    <div class="login-wrapper">
        ...
        <div class="login-card">
            ...
            <div class="portal-header">
                ...
                <p>
                    Sign in to access your peer-review assignments
                    and reviewer account.
                </p>
            ...
            <div class="login-body">
                ...
                <form
                    method="POST"
                    action="{{ route('reviewer.login.submit') }}"
                >
            ...
            <div class="login-footer">
                ...
                <p>
                    Want to become a BMRC Journal reviewer?
                </p>


                <a
                    href="{{ route('reviewer.register') }}"
